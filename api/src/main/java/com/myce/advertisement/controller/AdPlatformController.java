...
import com.myce.advertisement.service.AdPlatformDetailService;
...
public class AdPlatformController {
    private final AdPlatformService service;
    private final AdPlatformDetailService adDetailService;
    private final AdApplicationService applyAdService;
    private final AdPlatformCurrentService currentAdService;
