...
//    }
    ...
    public void cancel() {this.status = ExpoStatus.CANCELLED;}
    /**
     * 박람회 승인 처리
     * PENDING_APPROVAL -> PENDING_PAYMENT
     */
    public void approve() {this.status = ExpoStatus.PENDING_PAYMENT;}
    
    /**
     * 박람회 거절 처리
     * PENDING_APPROVAL -> REJECTED
     */
    public void reject() {this.status = ExpoStatus.REJECTED;}
